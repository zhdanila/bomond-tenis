...
type PostV1BomondVnCourtIDBookHandlerFunc func(PostV1BomondVnCourtIDBookParams) middleware.Responder

// Handle executing the request and returning a response
func (fn PostV1BomondVnCourtIDBookHandlerFunc) Handle(params PostV1BomondVnCourtIDBookParams) middleware.Responder {
	return fn(params)
}
...
type PostV1BomondVnCourtIDBookHandler interface {
	Handle(PostV1BomondVnCourtIDBookParams) middleware.Responder
}
